...
// THE ' IS TREATED AS THE 3 CHAR (WHICH IF YOU COUNT IT USING THE INDEX STARTING FROM 0 WILL BE THE 2 CHAR INSTEAD)
// SO WE HAVE TO TAKE THAT INTO ACCOUNT AND USE A SECOND INDEX THAT STARTS FROM 1
